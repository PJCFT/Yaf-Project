...
<div class="header">
    ...
    <div class="auth fr">
        <ul>
            <li><span>管理员：<?php echo $user['user_name'];?></span></li>
    ...
    <div class="addwrap">
        <div class="addl fl">
            ...
            <form name="publish-form" id="publish-form" action="do_edit.php" method="post"
                ...
                <div class="additem">
                    <label id="for-name">商品名称</label><input type="text" name="name" id="name" placeholder="请输入商品名称" value="<?php echo $goods['name'];?>">
                </div>
                <div class="additem">
                    <label id="for-price">价值</label><input type="text" name="price" id="price" placeholder="请输入商品价值" value="<?php echo $goods['price'];?>" >
                </div>
                <div class="additem">
                    <!-- 使用accept html5属性 声明仅接受png gif jpeg格式的文件                -->
                    <label id="for-file">商品</label><span><img src="<?php echo 'http://'.$goods['pic'];?>" alt="" style="height: 50px;"><input type="file" accept="image/png,image/gif,image/jpeg" id="file" name="file" style="width: 150px;"></span>
                </div>
